...
describe('Autenticación - Login y Logout', () => {
  ...
  describe('Login de Cliente', () => {
    it('Debe permitir login exitoso con credenciales válidas', () => {
      ...
      cy.loginAsClientSuccess(
        TEST_CREDENTIALS.cliente.rut,
        TEST_CREDENTIALS.cliente.password
      );
  ...
  describe('Navegación después de autenticación', () => {
    it('Debe redirigir cliente a la página principal', () => {
      cy.loginAsClientSuccess(
        TEST_CREDENTIALS.cliente.rut,
        TEST_CREDENTIALS.cliente.password
      );
  ...
  describe('Persistencia de datos', () => {
    it('Debe mantener datos del usuario después de navegar', () => {
      // Login
      cy.loginAsClientSuccess(
        TEST_CREDENTIALS.cliente.rut,
        TEST_CREDENTIALS.cliente.password
