...
export default function AdministradorPage() {
  ...
  return (
    <div className="bg-white flex flex-col md:flex-row py-7 px-12 items-start gap-7">
      ...
      {/* Compradores */}
      <div className="flex flex-col items-start gap-4 flex-1-0-0 md:max-w-[552px] md:min-w-[552px] md:bg-red-200">
        <div className="flex flex-col md:flex-row items-center gap-3 w-full">
          <button className="w-1/3 bg-gray-100 flex justify-between items-start p-[10px] h-10 text-gray-500 text-md">
            Montos
