...
export default function CompraExitosaPage() {
  ...
  return (
    <div className="bg-[#f5faf5] h-full flex mt-10 justify-center px-4">
      <div className="bg-white max-w-2xl h-fit mt-10 p-8 rounded-lg text-center shadow">
        <h1 className="text-3xl md:text-4xl font-bold text-black mb-4">¡Gracias por tu compra!</h1>
        ...
        <p className="mb-2 text-lg">Total de la compra: ${totalCompra.toLocaleString('es-CL')}</p>
        ...
        <p className="mt-6 text-sm text-gray-700 flex items-center justify-center gap-2">
          <span className="inline-block text-xl">ℹ️</span>
