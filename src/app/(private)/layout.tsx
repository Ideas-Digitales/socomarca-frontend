...
export default function PrivateLayout({
  ...
  const [carro, setCarro] = useState<Product[]>([]);
  const productos = useMemo<Product[]>(
    () => [
      {
        id: 1,
        name: 'Arroz G2 Largo Selección Tucapel 1kg',
        price: 1649,
        stock: 100,
        sku: 'ARZ001',
        description:
      ...
      {
        id: 2,
        name: 'Arroz Miraflores G2 Largo 800 Gr',
        price: 1097,
        stock: 150,
        sku: 'ARZ002',
        description:
      ...
      {
        id: 3,
        name: 'Arroz El País Largo Fino 1kg',
        price: 1299,
        stock: 80,
        sku: 'ARZ003',
        description:
      ...
      {
        id: 4,
        name: 'Tallarines Lucchetti 400gr',
        price: 999,
        stock: 90,
        sku: 'PST001',
        description:
      ...
      {
        id: 7,
        name: 'Avena Instantánea Quaker 400gr',
        price: 1295,
        stock: 120,
        sku: 'AVN001',
        description:
      ...
      {
        id: 8,
        name: 'Harina Selecta Sin Polvos 1kg',
        price: 1095,
        stock: 110,
        sku: 'HRN001',
        description:
      ...
      {
        id: 9,
        name: 'Sal Lobos Yodada Fina 1kg',
        price: 850,
        stock: 200,
        sku: 'SAL001',
        description:
      ...
      {
        id: 10,
        name: 'Salsa de Tomate Pomarola 200gr',
        price: 690,
        stock: 180,
        sku: 'SLT001',
        description:
