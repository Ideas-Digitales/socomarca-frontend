        ...
        <div className="sm:flex sm:h-[74px] sm:flex-col sm:justify-between sm:items-end sm:gap-[6px] sm:flex-1-0-0 gap-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
            ...
            <button
              onClick={addToCart}
              disabled={quantity === 0}
              className="flex w-full p-2 flex-col justify-center items-center rounded-[6px] border border-slate-400 text-slate-400 hover:bg-slate-50 h-[32px] text-[10px] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed hover:border-lime-500 hover:text-lime-500 transition-all duration-300 ease-in-out"
            >
              Agregar al carro
            </button>
          </div>
