...
// Mapeo de los posibles endpoints base
const ENDPOINTS = {
  products: 'products',
...
// Mapeo de los posibles sufijos para los endpoints
...
type Endpoint = 'products' | 'transactions' | 'customers' | 'dashboard' | 'municipalities' | 'categories' | 'orders';
...
export const fetchGetOrdersReportsTransactionsList = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/transactions`;
...
export const fetchGetOrdersReportsFailedTransactionsList = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/transactions/failed`;
    ...
    console.error(
      'Error fetching orders reports failed transactions list:',
      error
    );
    return {
      ok: false,
...
export const fetchGetOrdersReportsCharts = async (
  ...
  try {
          ...
          top_municipalities: [
            {
              ...
              total_purchases: 17534144,
              quantity: 45,
            },
            {
              month: '2025-01',
              municipality: 'Las Condes',
              total_purchases: 26128752,
              quantity: 38,
            },
            {
              month: '2025-02',
            ...
            {
              month: '2025-03',
              municipality: 'La Reina',
              total_purchases: 19234144,
              quantity: 41,
            },
            {
              month: '2025-03',
              municipality: 'Vitacura',
              total_purchases: 24128752,
              quantity: 35,
            },
          ],
    ...
    const endpointUrl = `${BACKEND_URL}/reports/dashboard`;
...
export const fetchGetTransactionDetails = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/transactions/${transactionId}`;
...
export const fetchGetClientsMostPurchasesList = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/customers`;
...
// Exportar transacciones - POST: /reports/transactions/export
export const exportTransactions = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/transactions/export`;
...
// Exportar municipios - POST: /reports/municipalities/export
export const exportMunicipalities = async (
  start: string,
  end: string,
  total_min?: number,
  total_max?: number
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/municipalities/export`;
    ...
    console.error('Error exporting municipalities:', error);
    return {
      ok: false,
      data: null,
      error: error instanceof Error ? error.message : 'Error desconocido',
...
// Exportar productos - POST: /reports/products/export
export const exportProducts = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/products/export`;
...
// Exportar categorías - POST: /reports/categories/export
export const exportCategories = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/categories/export`;
...
// Exportar clientes - POST: /reports/customers/export
export const exportCustomers = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/customers/export`;
...
// Exportar órdenes - POST: /reports/orders/export
export const exportOrders = async (
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/orders/export`;
...
// Productos más vendidos - POST: /reports/products/top-selling
export const fetchProductsTopSelling = async (
  start: string,
  end: string,
  per_page: number,
  page: number,
  ...
  try {
    ...
    const endpointUrl = `${BACKEND_URL}/reports/products/top-selling`;
    ...
    console.error('Error fetching products top selling:', error);
    return {
      ok: false,
      data: null,
      error: error instanceof Error ? error.message : 'Error desconocido',
